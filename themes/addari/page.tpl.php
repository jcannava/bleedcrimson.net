...
<script type="text/javascript" src="http://tcr.tynt.com/javascripts/Tracer.js?user=ademHw_Ier3OEXadbiUzgI&amp;s=32"></script>
</head>
...
<div id="hcenter">
<a href="http://www.bleedcrimson.net"><img src="/themes/addari/images/logo.png"></a>
...
<div id="footer"><?php if ($footer): ?> <div id="foot-block"><?php print $footer ?> </div><?php endif; ?><?php if ($footer_message): ?> <?php print $footer_message ?> | <?php endif; ?></div>
