<?php /* Smarty version 2.6.20, created on 2012-03-31 00:23:20
         compiled from gallery:modules/rewrite/templates/AdminRewrite.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'gallery:modules/rewrite/templates/AdminRewrite.tpl', 96, false),array('function', 'counter', 'gallery:modules/rewrite/templates/AdminRewrite.tpl', 198, false),)), $this); ?>
...
<?php if (isset ( $this->_tpl_vars['form']['error']['conditions']['dupe'][$this->_tpl_vars['moduleId']][$this->_tpl_vars['ruleId']] ) || isset ( $this->_tpl_vars['form']['error']['pattern']['dupe'][$this->_tpl_vars['moduleId']][$this->_tpl_vars['ruleId']] ) || isset ( $this->_tpl_vars['form']['error']['pattern']['empty'][$this->_tpl_vars['moduleId']][$this->_tpl_vars['ruleId']] ) || isset ( $this->_tpl_vars['form']['error']['1'][$this->_tpl_vars['moduleId']][$this->_tpl_vars['ruleId']] ) || isset ( $this->_tpl_vars['form']['error']['3'][$this->_tpl_vars['match']] ) || isset ( $this->_tpl_vars['form']['error']['4'][$this->_tpl_vars['moduleId']][$this->_tpl_vars['ruleId']] )): ?>
<div class="icon-plugin-incompatible" style="height:16px"
title="<?php echo $this->_reg_objects['g'][0]->text(array('text' => "Status: Error"), $this);?>
"></div>
<?php elseif (isset ( $this->_tpl_vars['rule']['active'] )): ?>
<div class="icon-plugin-active" style="height:16px"
title="<?php echo $this->_reg_objects['g'][0]->text(array('text' => "Status: Active"), $this);?>
"></div>
<?php else: ?>
<div class="icon-plugin-uninstall" style="height:16px"
title="<?php echo $this->_reg_objects['g'][0]->text(array('text' => "Status: Not Active"), $this);?>
"></div>
<?php endif; ?>
</td>
<td>
...
<td>
<?php if (! isset ( $this->_tpl_vars['rule']['pattern'] )): ?>
<?php echo $this->_reg_objects['g'][0]->text(array('text' => 'No URL Pattern'), $this);?>
...
<?php endif; ?>
<?php if ($this->_tpl_vars['AdminRewrite']['mode'] == 'setup'): ?>
<?php if ($this->_tpl_vars['AdminRewrite']['parserType'] == 'preGallery'): ?>
<div class="gbBlock">
