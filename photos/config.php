 ...
 */
$gallery->setConfig('setup.password', 'DpYsrHYV');
 ...
 */
$gallery->setConfig('data.gallery.base', '/var/www/bleedcrimson.net/photos/g2data/');
...
$storeConfig['hostname'] = '10.179.32.55';
$storeConfig['database'] = 'bcnet';
$storeConfig['username'] = 'bc';
$storeConfig['password'] = 'jddX6Pm5tiVmLNbOQKB_';
...
$gallery->setDebugLogFile('/tmp/gallery2.err');
 ...
 */
$gallery->setConfig('baseUri', 'http://www.bleedcrimson.net/photos/main.php');
?>
